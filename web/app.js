...
function unitCell(r,u,i,key){
 ...
 if(key==='inv')return `<strong>${esc(u.inv)||'—'}</strong>${u.imei?`<small title="IMEI">${esc(u.imei.slice(0,3)+'••••'+u.imei.slice(-4))}</small>`:''}`;
