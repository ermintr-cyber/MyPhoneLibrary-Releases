...
function modelActions(r){return `<div class="row-actions">${acquireButton(r)}<button class="primary" data-action="add-existing" data-id="${r.id}">+ Add another</button><button data-action="repairs" data-id="${r.id}">Repairs</button><button data-action="labels" data-id="${r.id}">QR labels</button><button data-action="history" data-id="${r.id}">History</button><button data-action="edit" data-id="${r.id}">Model details and images</button></div>`;}
